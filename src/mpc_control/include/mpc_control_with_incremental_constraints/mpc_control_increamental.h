#ifndef MPC_CONTROL_INCREAMENTAL_H
#define MPC_CONTROL_INCREAMENTAL_H
// osqp-eigen
...
namespace MPC_CONTROL_INCREAMENTAL
{
class MPC_Control
{
    protected:
        //-----------通过yaml传入的参数-------------//
        Eigen::Matrix<double,5,1> _xMax;
        Eigen::Matrix<double,5,1> _xMin;
        Eigen::Matrix<double,2,1> _uMax;
        Eigen::Matrix<double,2,1> _uMin;


        Eigen::DiagonalMatrix<double, 5> _Q;
        ...
        //----------------------------------------//
        //动态转移矩阵A
        Eigen::Matrix<double, 5, 5> _a;
        //动态转移矩阵B
        Eigen::Matrix<double, 5, 2> _b;
        */


        //------------需要输入的动态赋值的参数-------------//
        /*
        Eigen::Matrix<double,5,1> _x0;

        std::vector<Eigen::Matrix<double,5,1>> _xref;
    ...
    public:
        ...
        //设定 动态转移矩阵A B
        void setDynamicsMatrices(Eigen::Matrix<double, 5, 5> &a, Eigen::Matrix<double, 5, 2> &b,const Eigen::Matrix<double,5,1> &x0);
        //设定P Hession
        void castMPCToQPHessian(const Eigen::DiagonalMatrix<double, 5> &Q, const Eigen::DiagonalMatrix<double, 2> &R,int mpcWindow,
        ...
        void castMPCToQPGradient(const Eigen::DiagonalMatrix<double, 5> &Q,const std::vector<Eigen::Matrix<double, 5, 1>> &xRef,int mpcWindow,
        ...
        void castMPCToQPConstraintMatrix(const Eigen::Matrix<double, 5, 5> &dynamicMatrix, const Eigen::Matrix<double, 5, 2> &controlMatrix,
                                 int mpcWindow, int controlWindow,Eigen::SparseMatrix<double> &constraintMatrix);
        //设定upper and lower bound
        void castMPCToQPConstraintVectors(const Eigen::Matrix<double, 5, 1> &xMax, const Eigen::Matrix<double, 5, 1> &xMin,
        ...
        //求解
        bool step(const Eigen::Matrix<double,5,1>&x0,const std::vector<Eigen::Matrix<double,5,1>> &xref);
